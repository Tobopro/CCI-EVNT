    ...
    <main>
        <div class="cover-and-info-edit">
            <div class="cover-edit-picture">
                ...
                <a href="#">
                    <div>
                        <img class="cover-edit-picture__img" src="./img/tourne-disque-tournant-vinyle-vintage.jpg"
                            alt="bannière de profil">
                        <img class="cover-edit-picture__icon" src="img/icone/camera-solid.svg"
            ...
            <div id="profile-edit-up" class="row m-0">
                <a href="#">
                    <div id="profile-edit-picture" class="col-4 col-md-2 col-lg-2">
                        <img id="profile-edit-picture__img" src="img/portrait.jpg" alt="photo de profil">
                        <img id="profile-edit-picture__icon" src="img/icone/camera-solid.svg"
