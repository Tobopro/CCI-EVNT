<div class="container-fluid">
    <div class="row d-flex justify-content-center">
        ...
        <a class="col-6" href="index.php?url=my_events">
        ...
        <article class="evnt-single col-3 m-5">
            <a href="">
                <img class="img-une" src="<?php ec($hydratedUser->getProfilePicture()) ?>"
                    alt="photographie d'un groupe de fêtard" />
                <div class="padding-evnt">
                    <ul class="details-evnt">
                        <li> <?php ec($hydratedUser->getEmail()) ?></li>
                        <li> <?php ec($hydratedUser->getFirstName()) ?></li>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <form action="/handlers/user-handler.php" method="POST">
                                    ...
                                    <input type="text" name="id" value="<?php ec($id) ?>" hidden>
