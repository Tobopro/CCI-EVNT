...
if (strlen($event_name_register) < 5 || !preg_match('/^[A-Za-z0-9\'"]+$/', $event_name_register)) {
...
} elseif (strlen($event_description_register) < 10 || !preg_match('/^[A-Za-z0-9\'"]+$/', $event_description_register)) {
